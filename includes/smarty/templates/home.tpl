        ...
        <div>
          <div class="tab-content">
            <div role="tabpanel" class="tab-pane fade active in">
              ...
              {/foreach}
              <button type="button" class="btn bg-{$theme} form-control" data-target="[loadMore]" {if count($post) <=5}style="display:none" {/if} id="loadMore">Hiển Thị Thêm</button>
              {else}
      ...
      <div class="card card-about-me">
        ...
        <div class="body">
          <ul id="list_comment">
            ...
            <li>
              <div class="title">
                <a href="/post/{$value.url}.html#list_comment" class="col-{$theme}">{$value.from}</a>
              </div>
              <div class="content">
                {$value.comment|nl2br}
                <br />
