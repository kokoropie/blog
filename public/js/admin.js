...
var $theme = $('.right-sidebar .demo-choose-skin li.active').data('theme');
...
$.AdminBSB.leftSideBar = {
  activate: function() {
    ...
    $(window).click(function(e) {
      ...
      if (!$target.hasClass('bars') && _this.isOpen() && $target.parents('#leftsidebar').length === 0) {
        ...
        $body.removeClass('overlay-open lg-on');
      }
    });
  ...
  setMenuHeight: function(isFirstTime) {
    if (typeof $.fn.slimScroll != 'undefined') {
      ...
      var height = ($(window).height() - ($('.legal').outerHeight() + $('.breadcrumb').outerHeight() + $('.user-info').outerHeight() + $('.navbar').innerHeight()));
      var $el = $('.list');
...
$.AdminBSB.search = {
  activate: function() {
    ...
    //ESC key on pressed
    $searchBar.find('input[name="q"]').on('keyup', function(e) {
      if (e.keyCode == 27) {
        _this.hideSearchBar();
  ...
  showSearchBar: function() {
    ...
    $searchBar.find('input[name="q"]').focus();
  },
  hideSearchBar: function() {
    $searchBar.removeClass('open');
    $searchBar.find('input[name="q"]').val('').blur();
  }
}
//==========================================================================================================================
...
$.AdminBSB.navbar = {
  activate: function() {
    ...
    $('.bars').on('click', function() {
      $body.toggleClass('overlay-open lg-on');
...
/* Form - Tagsinput - Function ================================================================================================
 */
$.AdminBSB.tagsinput = {
  activate: function() {
    if ($.fn.tagsinput) {
      $("input[data-role=tagsinput], select[multiple][data-role=tagsinput]").tagsinput({
        tagClass: 'label bg-' + $('.right-sidebar .demo-choose-skin li.active').data('theme')
      });
    }
  }
}
  ...
  activate: function() {
    if ($.validator) {
      $.extend($.validator.messages, {
        ...
        url: "Vui Lòng Nhập Định Dạng Url",
...
var $hlTheme = "atom-one-dark-reasonable";
